<h1 align="center">Informe de TB1</h1>
...
<p align="left">
    <strong>Docente: </strong>David Gerardo Quevedo Velasco<br><!--El br es para el salto de línea-->
    <strong>NRC: </strong>14649<br>
    <strong>Ciclo: </strong>2025 - 20<br>
    <strong>Startup: </strong>GigU<br>
    ...
    <table align="center" border="1" cellpadding="8" cellspacing="0" style="border-collapse: collapse; width: 100%;">
        ...
        <tr>
            <td style="border: 1px solid #ddd; vertical-align: top;">
                7.c1. Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de ingeniería
                de software
            </td>
            <td style="border: 1px solid #ddd; vertical-align: top;">
                <strong>Irving Allcca</strong><br>TB1:<br><br>
                <strong>Diego Cacho</strong><br>TB1:<br><br>
                <strong>Adrian Donayre</strong><br>TB1:<br><br>
                <strong>Mariano Oblitas</strong><br>TB1:<br><br>
                <strong>Carlos Fernandez</strong><br>TB1:<br>
            </td>
            <td style="border: 1px solid #ddd; vertical-align: top;">
            </td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd; vertical-align: top;">
            7.c2. Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo
            de proyectos en soluciones de tecnologías de ingeniería de software
            </td>
            <td style="border: 1px solid #ddd; vertical-align: top;">
                <strong>Irving Allcca</strong><br>TB1:<br><br>
                <strong>Diego Cacho</strong><br>TB1:<br><br>
